...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["id"]) and $_GET['action'] === 'delete')  {
    ...
    $stmt = $conn->prepare("DELETE FROM expense_details WHERE id = ?");
    ...
    if ($stmt->execute()) {
        // Redirect to the page showing all expense details
        ...
        <div class="container">
            <table id="expenseTable" class="table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                    ...
                    $sql = "SELECT ed.id, et.name AS expense_type, ed.amount, ed.description, ed.expense_date FROM expense_details ed INNER JOIN expense_type et ON ed.expense_type_id = et.id";
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <a href='update-expense-details.php?id=<?php echo $row["id"]; ?>' class='btn btn-primary'><i class='fa fa-pencil'></i></a>
                    ...
                    <?php
                        ...
                        echo "<tr><td colspan='6'>No expense details found</td></tr>";
                    }
